...
# Load the Model 
net = cv.dnn.readNet('/home/pi/RREI/Dlink/RoadDetection/person-vehicle-bike-detection-crossroad-0078-FP32.xml', '/home/pi/RREI/Dlink/RoadDetection/person-vehicle-bike-detection-crossroad-0078-FP32.bin')
...
#Create output file
txt_file = open(file_full_name.replace(".mp4",".json"), 'w+')
logging.info("Create file {}\n".format(txt_file))
print("Create file {}\n".format(txt_file))
txt_file.write('{{\n  "record": {{\n    "filename" : {6},\n    "time_length" : {0},\n    "fps": {1},\n    "frame_jump" : {2},\n    "width" : {3},\n    "heigh" : {4},\n    "start_time" : "{5}",\n    "detections" :[\n'.format(time_length, fps, frame_jump, width, heigh, start_datetime, filename))
